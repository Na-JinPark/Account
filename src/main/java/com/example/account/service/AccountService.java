...
public class AccountService {
    ...
    public AccountDto deleteAccount(Long userId, String accountNumber) {
        ...
        validateDelete1Account(accountUser, account);
    ...
    private void validateDelete1Account(AccountUser accountUser, Account account) {
        ...
        if(account.getBalance() > 0){
            throw new AccountException(BALANCE_NOW_EMPTY);
        }
    }
    @Transactional
